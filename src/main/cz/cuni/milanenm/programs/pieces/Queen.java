 ...
 * The Queen moves in all directions (vertically, horizontally, diagonally).
 */
public class Queen extends Piece {

    /**
     * Constructor to initialize the Queen piece with its team and the board cells
    ...
    /**
     * Method to get the list of cells available for the Queen's move
     * @return A list of available cells for the Queen to move
     */
    @Override
